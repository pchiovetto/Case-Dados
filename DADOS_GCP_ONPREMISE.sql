...
(SELECT 'GCP' AS TABELA, ID,CODE_GENDER,COUNT(CODE_GENDER) QTDE_CODE_GENDER,FLAG_OWN_CAR,COUNT(FLAG_OWN_CAR) QTDE_FLAG_OWN_CAR 
  FROM DADOS_GCP GROUP BY CODE_GENDER,ID,FLAG_OWN_CAR) 

B ON A.ID=B.ID 

GROUP BY  A.TABELA,A.CODE_GENDER,B.TABELA,B.CODE_GENDER
